...
| **Save as PDF** | Opens the browser print dialog. Prints as **164 exact A4 pages** from either mode — the reader chrome is hidden and the true page geometry is restored. |
| **Page counter** | Live folio, `12 / 164`, from the book's own page numbers. |
...
**Part Seven — Room by Room** (pp. 145–164)

The three reference sections are still to be written: The Measurements (p. 165),
The Room Audit (p. 181) and What Not to Buy (p. 189), ending at p. 204.
